      ...
      <nav className="fixed top-0 w-full flex justify-between h-[71px]  mx-w-[1240px] mx-auto px-4 bg-white text-black py-3 text-lg z-10 border-b ">
        ...
        <div className="nav-list flex justify-center items-center flex-grow">
          <ul className="hidden md:flex justify-center px-4 gap-[4vw] uppercase">
            <Link href="/">
              <li className="cursor-pointer underline underline-offset-8 hover:no-underline  text-[20px] transition ease-in-out delay-15 md:hover:-translate-y-1 hover:scale-105 duration-300">
                Home
              </li>
            </Link>
            <Link href="/about">
